...
define(['jquery', 'underscore', 'backbone', 'bootstrap', 'jqueryform', 'views/SignInView', 'text!templates/alert.html', 'text!templates/registryFields.html',
    ...
    insertBetaLink: function(){
      //Insert image
       var img = $(document.createElement("img"))
                  .attr("src", "img/Try-Beta-Editor.svg")
                  .attr("class", "center img-polaroid")
                  .css("display", "block")
                  .attr("usemap", "#Beta-Link-Map");
      var map = $(document.createElement("map")).attr("name", "Beta-Link-Map").append(
        '  <area target="" alt="Try the beta" title="Try the beta" href="https://beta.arcticdata.io/catalog/#submit" coords="21,113,139,158" shape="rect">' +
          '<area target="" alt="Not now" title="Not now" href="" coords="166,123,236,147" shape="rect" class="close-beta-link" >' +
          '<area target="" alt="Close" title="Close" href="" coords="566,1,599,30" shape="rect" class="close-beta-link" >');


      this.$("#RegistryEntryForm").prepend( map, img );

      $(".close-beta-link").on("click", function(e){
        e.preventDefault();
        img.remove();
      });
    },
