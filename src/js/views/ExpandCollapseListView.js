define(['jquery', 'underscore', 'backbone'],
	...
	var ExpandCollapseListView = Backbone.View.extend({
      ...
      if( MetacatUI.appModel.get("d1Service").indexOf("cn") > -1 ){
        objectURL = MetacatUI.appModel.get('resolveServiceUrl') + encodeURIComponent(id);
      }
      else{
         objectURL = MetacatUI.appModel.get('objectServiceUrl') + encodeURIComponent(id);
      }
			return $(document.createElement("a")).attr("href", objectURL).text(id);
		},
